<div class="workpage-container">
  <h1 class="headline-left">rakuten</h1>
  <p class="summary">
    Rakuten is a renowned Japanese company specializing in electronic commerce
    and online retailing. It operates in over 20 countries and regions, and one
    of its crucial operation hubs is Rakuten Taiwan. The company's operations in
    Taiwan extend beyond the local market to encompass international system
    design, underscoring its significant role in the global e-commerce
    landscape.
  </p>
  ...
  <div class="overview-container-right">
    <p class="overview">
      ...
      <br /><br />During my time as a researcher at Rakuten from 2017 to 2018, I
  ...
  <h1 class="headline-left">my approach</h1>
  <div class="overview-container-left">
    <p class="overview">
      ...
      research with qualitative research methods such as interviews, journaling, field
      studies, focus groups, and usability testing. These methods allowed me to gain
      a more comprehensive understanding of our customers' experiences and uncover
      insights that may have been missed through data analysis alone.
    </p>
  </div>

  <h1 class="headline-right">cases</h1>
  <div class="overview-container-right">
    <h2 class="overview-headline">usability testing</h2>
    <p class="overview">
  ...
  <div class="overview-container-left">
    <h2 class="overview-headline">cognition experiment</h2>
    <p class="overview">
      ...
      used by some of our competitors. I aimed to evaluate how general consumers interpreted
      these words and how they felt about the sentences used in the copy. By doing
      so, I gained insights into how we could communicate more effectively with our
      target audience and better meet their needs.
      <br /><br />
      ...
      audience.
      <br /><br />
      By carefully considering the language and tone used in our communication, we
      were able to more effectively connect with our customers and provide them with
      a more positive and engaging experience on our platform.
    </p>
  </div>

  <div class="overview-container-right">
    <h2 class="overview-headline">marketing campaign enhancement</h2>
    <p class="overview">
      ...
      different types of marketing campaigns, such as discounts of 30%, coupons, or
      Rakuten's super points. Through this study, we gained insights into how customers
      perceived different types of discounts and which discounts were most effective
      in driving checkout behaviour.
      <br /><br />
  ...
  <p class="summary">
    By leveraging data-driven insights and refining our approach over time, we
    were able to create more impactful and engaging product that helped drive
    increased sales and revenue for Rakuten. By continually measuring and
    optimising our product, we were able to remain competitive in an
    ever-changing market and continue to grow our business over the long term.
  </p>
  <p class="summary" style="padding-bottom: 128px;">
    Through the development of a series of research methods for measuring the
    user experience, we were able to compare results across different seasons
    and collaborate more effectively with the marketing team to create campaigns
    that resonated more strongly with our customers.
  </p>
</div>
